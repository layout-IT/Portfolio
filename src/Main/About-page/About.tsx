                    ...
                    <div className={s.about_meBlockText}>
                        ...
                        <div className={s.about_meList}>
                            ...
                            <ul className={s.about_meListLists}>
                                <li className={s.about_meListText}><span>Full Name</span> <span>: Devid Chester</span>
                                </li>
                                <li className={s.about_meListText}><span>Age</span><span>: 24 Years</span></li>
                ...
                <div className={s.Services_items}>
                    <div className={s.Services_column}>
                        <div className={s.Services_item}>
                            ...
                            <div className={s.Services_itemTitle}>Web Design</div>
                            <div className={s.Services_itemStripe}></div>
                            <p className={s.Services_itemText}>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    ...
                    <div className={s.Services_column}>
                        <div className={s.Services_item}>
                            ...
                            <div className={s.Services_itemTitle}>Mobile Application</div>
                            <div className={s.Services_itemStripe}></div>
                            <p className={s.Services_itemText}>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Autem tenetur ratione quod.</p>
                        </div>
