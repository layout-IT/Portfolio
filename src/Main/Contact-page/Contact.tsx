...
import style from "../Portfolios-page/Portfolios.module.scss";
    ...
    return (
        <div className={style.portfolioWrapper}>
            <div className={style.portfolioWrapper_container}>
                ...
                <div className={s.contactMe_items}>
                    <div className={s.contactMe_column}>
                        <div className={s.contactMe_item}>
                            <div className={s.contactMe_icon}>
                            ...
                            <div className={s.contactMe_Block}>
                                <div className={s.contactMe_Title}>Phone</div>
                                <div className={s.contactMe_subtitle1}>+012-3456-7892</div>
                                <div className={s.contactMe_subtitle1}>+012-3456-7892</div>
                            </div>
                        </div>
                    </div>
