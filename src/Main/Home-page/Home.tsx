            ...
            <div className={s.wrapperContainer}>
                ...
                <div className={s.wrapperContainer_items}>
                    ...
                    <div className={s.container_span}>
                        <a href="https://t.me/SergeiMakshakov" target={'_blank'} className={s.container_span_svg}>
                        ...
                        <a href="https://www.codewars.com/users/layout-IT" target={'_blank'} className={s.container_span_svg}>
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="code" role="img"
                                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                                 className="svg-inline--fa fa-code fa-w-20 fa-5x">
                                <path fill="currentColor"
