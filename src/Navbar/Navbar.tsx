...
export function Navbar(props: NavbarType) {
    ...
    return <div className={!props.active ? s.WrapperFAlse : s.Wrapper}>
        ...
        <div className={s.items}>
            ...
            <NavLink onClick={() => closeMenu()} to={'/resume'} activeClassName={s.ChangeColorOnBlue}
                     className={s.item}><span
                className={s.item_link}>Resume</span></NavLink>
            <NavLink onClick={() => closeMenu()} to={'/portfolios'} activeClassName={s.ChangeColorOnBlue}
                     className={s.item}><span
                className={s.item_link}>Portfolio</span></NavLink>
            <NavLink onClick={() => closeMenu()} to={'/contact'} activeClassName={s.ChangeColorOnBlue}
                     className={s.item}><span
